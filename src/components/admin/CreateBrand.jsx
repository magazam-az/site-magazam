...
const CreateBrand = () => {
  ...
  return (
    <AdminLayout pageTitle="Yeni Brend">
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="mb-8">
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
              <div>
                <h1 className="text-3xl font-bold text-[#5C4977] mb-2">Yeni Brend Əlavə Et</h1>
                <p className="text-gray-600">Yeni brend məlumatlarını daxil edin</p>
              </div>
              <button
