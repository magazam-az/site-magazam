...
const CreateCategory = () => {
  ...
  return (
    <AdminLayout pageTitle="Yeni Kateqoriya">
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="mb-8">
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
              <div>
                <h1 className="text-3xl font-bold text-[#5C4977] mb-2">Yeni Kateqoriya Əlavə Et</h1>
                <p className="text-gray-600">Yeni kateqoriya məlumatlarını daxil edin</p>
              </div>
              <button
