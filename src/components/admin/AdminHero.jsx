...
import { useGetAllHeroesQuery, useDeleteHeroMutation } from "../../redux/api/heroApi";
...
const AdminHero = () => {
  ...
  const { data, isLoading, refetch } = useGetAllHeroesQuery();
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="mb-8">
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
              <div>
                <h1 className="text-3xl font-bold text-[#5C4977] mb-2">Hero İdarəetməsi</h1>
                <p className="text-gray-600">Hero-ları idarə edin</p>
              </div>
          ...
          <div className="bg-white rounded-2xl shadow-xl border border-[#5C4977]/10 p-6">
            <div className="flex items-center justify-between mb-6">
              <h2 className="text-xl font-bold text-[#5C4977]">Hero Siyahısı</h2>
                    ...
                    >
                      ...
                      <td className="py-4 px-4">
                        <div className="flex items-center gap-2">
                          <button
                            onClick={() => navigate(`/admin/edit-hero/${hero._id}`)}
