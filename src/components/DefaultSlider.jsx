...
export default function DefaultSlider({ sliderData }) {
  if (!sliderData) return null;

  const slides = sliderData.slides || [];
  const rightTop = sliderData.rightTop || {};
  const bottomBlocks = sliderData.bottomBlocks || [];
  ...
  return (
    <Container>
      <div className="w-full my-5">
                ...
                {slides.map((slide, index) => (
                  <SwiperSlide key={index}>
                    <div
                      ...
                      style={{
                        "--bg": slide.image?.url ? `url(${slide.image.url})` : "none",
                      }}
                    >
                      <div className="relative z-10">
                        <h2 className="text-2xl md:text-4xl apas mb-4 text-center">{slide.title}</h2>
                        <p className="text-base text-gray-300 mb-5 text-center">{slide.description}</p>
            ...
            {rightTop.image?.url && (
              ...
              >
                <div className="relative z-10 px-1">
                  ...
                  <div className="flex gap-2 mb-4">{rightTop.endDate && <CountdownTimer endDate={rightTop.endDate} />}</div>
        ...
        {/* CSS for image zoom + pagination bullets */}
        <style>{`
          .hero-image-zoom-bg {
            position: relative;
            overflow: hidden;
          ...
          .hero-image-zoom-bg:hover::before {
