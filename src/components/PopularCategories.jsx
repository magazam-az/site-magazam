 ...
 <Container>
  ...
  >
    ...
    <div className="w-full flex justify-center items-center h-40">
      {/* Bu şəkili istifadəçi təqdim etdiyi kimi görünməsi üçün böyük etdik */}
      <img 
        src={imageUrl} 
        alt={imageAlt} 
...
export default function PopularCategories() {
  return (
    ...
    <div className="container mx-auto w-full p-4 sm:p-6 bg-white">
      ...
      {/* Kateqoriya Kartları */}
      <div className="flex overflow-x-auto gap-4 sm:gap-6 pb-4 -mx-4 sm:mx-0 px-4 sm:px-0 scrollbar-hide">
        ...
        {/* Scrollbarı gizlətmək üçün fərdi CSS */}
        <style jsx="true">{`
