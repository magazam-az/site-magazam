  ...
  return (
    ...
    <div className="min-h-screen bg-gradient-to-br bg-gradient-to-r from-pink-100/50 via-purple-100/70 to-blue-100/50 p-4 sm:p-8 font-lexend-deca">
      ...
      <div 
        ...
        className={`flex flex-col md:flex-row items-center justify-center rounded-xl p-6 sm:p-10 mb-12 max-w-[1350px] mx-auto`}
      >
      ...
      <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-5 gap-4 sm:gap-6 max-w-[1350px] mx-auto">
