        ...
        <Container>
          <div className="w-full py-4 sm:py-6">
            <div className="text-center p-12">
              <p className="text-red-600">Xəta baş verdi: {error.message || "Blog yazıları yüklənərkən xəta baş verdi"}</p>
            </div>
          </div>
        </Container>
      </section>
    ...
    return (
      <section className="bg-gray-100">
        <Container>
          <div className="w-full py-4 sm:py-6">
            <div className="text-center p-12">
              <p className="text-gray-600">Hələ blog yazısı yoxdur.</p>
            </div>
          </div>
        </Container>
      </section>
              ...
              {articles.map((article) => (
                ...
                >
                  ...
                  >
                    ...
                    <Link to={`/blogs/${article.slug}`} className="relative w-full h-64 overflow-hidden cursor-pointer block">
                      <img
                        src={article.image}
                        alt={article.title}
